...
Note, if you are on Google Chrome, Brave, and Opera (and possibly Firefox now, see note below), you will need to turn on the developer mode extension setting for Tampermonkey to work properly, see the instructions here:
